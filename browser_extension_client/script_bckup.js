...
async function handleSend() {
    ...
    if (message) {
        ...
        //   if (message.toLowerCase().includes('csv') || message.toLowerCase().includes('sheet')) {
        //     addMessage("Easy! Here you go.");
        //     addFileAttachment("Top_20_SaaS_Companies.csv");
        //   } else {
...
closeButton.addEventListener('click', () => {
    // Handle close button click - you can customize this based on your needs
